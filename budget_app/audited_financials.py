    ...
    <div class="section">
        <div class="header-row">
            ...
            <div style="display:flex; align-items:center; gap:12px;">
                <span id="afsScanStatus" style="font-size:13px; color:var(--gray-500);"></span>
                <button class="btn-green" id="afsScanBtn" onclick="afsScan()" title="Scan SharePoint for 2025 audit PDFs across all buildings and pull any new ones into this list">Scan SharePoint</button>
            </div>
        </div>
        <div id="uploadsTable">
            {{ uploads_table }}
...
<script>
    ...
    function afsScan() {
        ...
        fetch('/api/admin/audit-scan-master', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: '{}' })
            ...
            .catch(function(e) {
                btn.disabled = false;
                btn.textContent = 'Scan SharePoint';
