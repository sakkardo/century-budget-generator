...
@app.route("/api/admin/research-comm-rent/<entity_code>", methods=["GET"])
def admin_research_comm_rent(entity_code):
    """RESEARCH-ONLY: dump the structure of every non-yrlycomp sheet in this
    building's approved 2026 budget Excel, focusing on commercial rent and
